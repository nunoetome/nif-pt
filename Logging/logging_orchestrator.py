"""logging_orchestrator.py — Configuração do sistema de logging.
...
LOG_OUTPUT_FILE = os.path.join(LOG_FOLDER, 'nif_pt.log')
...
def ini_logging():
    ...
    # CONSOLE HANDLER — stderr para não quebrar pipeline stdout
