...
LOG_OUTPUT_FILE = os.path.join(LOG_FOLDER, 'p3_parse_xml.log')
...
class RotatingFileHandler(logging.Handler):
    ...
    Arquivos gerados::
        ...
        logging_p3_parse_xml.log       ← ficheiro de escrita atual
        logging_p3_parse_xml_1.log     ← arquivo mais recente
        logging_p3_parse_xml_2.log     ← ...
        logging_p3_parse_xml_N.log     ← arquivo mais antigo (removido no próximo ciclo)
    """
