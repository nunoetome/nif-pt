...
LOG_OUTPUT_FILE = os.path.join(LOG_FOLDER, 'p4_enrich_external.log')
...
class RotatingFileHandler(logging.Handler):
    ...
    Arquivos gerados::
        ...
        p4_enrich_external.log       ← ficheiro de escrita atual
        p4_enrich_external_1.log     ← arquivo mais recente
        p4_enrich_external_2.log     ← ...
        p4_enrich_external_N.log     ← arquivo mais antigo (removido no próximo ciclo)
    """
