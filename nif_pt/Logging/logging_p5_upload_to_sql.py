...
LOG_OUTPUT_FILE = os.path.join(LOG_FOLDER, 'p5_upload_to_sql.log')
...
class RotatingFileHandler(logging.Handler):
    ...
    Arquivos gerados::
        ...
        p5_upload_to_sql.log       ← ficheiro de escrita atual
        p5_upload_to_sql_1.log     ← arquivo mais recente
        p5_upload_to_sql_2.log     ← ...
        p5_upload_to_sql_N.log     ← arquivo mais antigo (removido no próximo ciclo)
    """
