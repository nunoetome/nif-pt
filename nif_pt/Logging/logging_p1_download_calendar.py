...
LOG_OUTPUT_FILE = os.path.join(LOG_FOLDER, 'p1_download_calendar.log')
...
class RotatingFileHandler(logging.Handler):
    ...
    Arquivos gerados::
        ...
        p1_download_calendar.log       ← ficheiro de escrita atual
        p1_download_calendar_1.log     ← arquivo mais recente
        p1_download_calendar_2.log     ← ...
        p1_download_calendar_N.log     ← arquivo mais antigo (removido no próximo ciclo)
    """
